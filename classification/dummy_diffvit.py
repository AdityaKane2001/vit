"""
Demonstration of having a ViT model with different architecture, and a different 
forward pass.
"""
...
class MyAmazingDifferentAttention(nn.Module):
    ...
    def __init__(
        ...
        ##### Your amazing architectural change here
        self.additional_proj = nn.Linear(dim, dim)
...
class MyAmazingDifferentBlock(nn.Module):
    def __init__(
            self,
            dim: int,
            num_heads: int,
        ...
        self.attn = MyAmazingDifferentAttention(
            dim,
            num_heads=num_heads,
            qkv_bias=qkv_bias,
            qk_norm=qk_norm,
...
class MyAmazingDifferentVisionTransformer(nn.Module):
    """ Vision Transformer
    ...
    def __init__(
            ...
            block_fn: Type[nn.Module] = MyAmazingDifferentBlock,
